...
Summary(pl):	Prosta biblioteka zastÍpuj±ca svgalib, oparta o aalib
Name:		aavga
Version:	1.0rc1
Release:	1
License:	GPL
...
%description -l pl
Prosta biblioteka zastÍpuj±ca svgalib, odwo≥uj±ca siÍ do aalib -
biblioteki wy∂wietlaj±cej grafikÍ jako ascii art. aavga pozwala
uruchamiaÊ programy korzystaj±ce z svgalib w trybie tekstowym.
